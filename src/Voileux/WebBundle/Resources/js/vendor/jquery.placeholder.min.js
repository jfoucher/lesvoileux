...
(function($){
    ...
    function bindEvents() {
        ...
        $("body").bind('form', 'reset', function(){
            $(this).find('.' + ph).each(itemBlur);
        });
        $('body')
            .bind('.' + ph, 'keydown',itemFocus)
            .bind('.' + ph, 'mousedown',itemFocus)
            .bind('.' + ph, 'mouseup',itemFocus)
            .bind('.' + ph, 'mouseclick',itemFocus)
            .bind('.' + ph, 'focus',itemFocus)
            .bind('.' + ph, 'focusin',itemFocus)
            .bind('.' + ph, 'blur',itemBlur)
            .bind('.' + ph, 'focusout',itemBlur)
            .bind('.' + ph, 'change',itemChange)
            .bind('.' + phl, 'click', function() {  $($(this).data(ph)).focus(); })
            .bind('.' + phl, 'mouseup', function() {  $($(this).data(ph)).focus(); });
//        bound = true;
